...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'auth:admin'], function () {
        ...
        Route::get('/product', [ProductController::class, 'index'])->name('admin.product.index')->middleware(['can:product.view']);
        Route::get('/product/list', [ProductController::class, 'list'])->name('admin.product.list')->middleware('can:product.view');
        Route::get('/product/getData', [ProductController::class, 'getAjaxData'])->name('admin.product.getData')->middleware('can:product.view');
        Route::post('/product/search', [ProductController::class, 'search'])->name('product.search')->middleware('can:product.view');
        Route::delete('/product/delete/{id}', [ProductController::class, 'destroy'])->name('admin.product.delete')->middleware('can:product.delete');
        Route::get('/product/edit/{id}', [ProductController::class, 'edit'])->name('product.edit')->middleware('can:product.edit');
        Route::put('/product/update/{id}', [ProductController::class, 'update'])->name('product.update')->middleware('can:product.edit');
        ...
        Route::post('/manufacturer/search', [ProductController::class, 'manufacturerSearch'])->name('product.manufacturerSearch')->middleware('can:product.view');
        Route::post('/sales-channel/search', [ProductController::class, 'searchSalesChannel'])->name('product.salesChannelSearch')->middleware('can:product.view');
        Route::post('/sales-channel/search', [ProductController::class, 'searchSalesChannel'])->name('product.salesChannelSearch')->middleware('can:product.view');
        Route::post('/category', [ProductController::class, 'categorySearch'])->name('product.categorySearch')->middleware('can:product.view');
        Route::post('/fetch-tax-providers', [ProductController::class, 'fetchTaxProviders'])->name('product.fetchTax')->middleware('can:product.view');
        Route::post('/product/update-stock', [ProductController::class, 'updateStock'])->name('product.update_stock')->middleware('can:product.edit');
        Route::post('/product/propertyGroupSearch', [ProductController::class, 'propertyGroupSearch'])->name('product.propertyGroupSearch')->middleware('can:product.view');
        Route::post('/product/propertyGroupOptionSearch', [ProductController::class, 'propertyGroupOption'])->name('product.propertyGroupOptionSearch')->middleware('can:product.view');
