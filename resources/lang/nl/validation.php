...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'category' => 'Categorie',
        'priceGross' => 'DGM verkoopprijs',
        'priceNet' => 'Prijs (netto)',
        'purchasePrice' => 'Inkoopprijs',
        'purchasePriceNet' => 'Inkoopprijs',
        'listPriceGross' => 'Catalogusprijs',
        'listPriceNet' => 'Catalogusprijs (netto)',
        'bolProductShortDescription' => 'Korte beschrijving',
        'bolNlPrice' => 'Bol NL prijs',
        'bolBePrice' => 'Bol BE prijs',
        'bolCondition' => 'Bol conditie',
        'bolConditionDescription' => 'BOL-conditiebeschrijving',
        'bolBEDeliveryTime' => 'Bol BE Levertijd',
        'bolNLDeliveryTime' => 'Bol NL Levertijd',
        'bin_location_id' => 'Binlocatie',
        'bolProductName' => 'Naam',
        'bolProductSku' => 'Productnummer',
        'bolTaxId' => 'Belasting-ID',
        'bolProductDescription' => 'Beschrijving',
        'bolProductPrice' => 'DGM verkoopprijs',
        'bolTotalPrice' => 'Prijs (netto)',
        'bolProductListPriceGross' => 'Advies Verkooprijs',
        'bolProductListPriceNet' => 'Advies Verkooprijs (netto)',
        'salesChannelBol' => 'Verkoopkanaal',
        'bolStock' => 'Voorraadhoeveelheid',
        'bolProductManufacturerId' => 'Fabrikant',
        'bolProductCategoriesId' => 'Categorieën',
    ],
